...
public class AddUserPage extends Utility {
    ...
    public void enterEmployeeName() throws InterruptedException {
        sendTextToElement(enterEmployeeName, "Vina");
        Thread.sleep(2000);
        clickOnElement(getEnterEmployeeName);
    }

    public void enterUserName() {
        sendTextToElement(enterUserNameField, "Vina");
    }
    ...
    public void enterPassword() {
        sendTextToElement(enterPassword, "Rwea@12345");
    }

    public void enterConfirmPassword() {
        sendTextToElement(enterConfirmPassword, "Rwea@12345");
    }
